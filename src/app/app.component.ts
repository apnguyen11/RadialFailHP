...
export class AppComponent {
  ...
  ngOnInit() {
    ...
    this.sub = Observable.interval(0.00000000001)
    .subscribe((val) => {
  ...
  getCementService() {
      ...
      let startLastDate = new Date("2020-01-13T23:52:30");
      let endLastDate = new Date("2020-01-13T23:57:30");
   ...
   console.log(this.xDateMin)
      this.xDateMin.setMinutes(this.xDateMin.getMinutes() - 30);
      // this.xDateMax.setMinutes(this.xDateMax.getMinutes() - 30);
      this.xDateMax.setHours(this.xDateMax.getHours() + 2);
  }
            ...
            .call(g =>
              g
                ...
                .attr(
                  ...
                  A${innerRadius / 1.95},${innerRadius / 1.95} 1,1,1 ${d3.pointRadial(x(b), innerRadius / 20)}
              `,
                )
                .selectAll(".tick text")
                .each(function(_,i){
...
console.log(endLastDate, lastHPDate)
